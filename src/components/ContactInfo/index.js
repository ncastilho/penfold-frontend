    ...
    return (
        <div>
          ...
          <div className="text-sm-right g-mb-20">
            <button className="btn btn-sm u-btn-primary" onClick={this.handleEdit}>Change</button>
          </div>
          }
          {!this.state.disabled &&
          <div className="text-sm-right g-mb-20">
            <button className="btn btn-sm u-btn-darkgray g-mr-10" onClick={this.handleCancel}>Cancel</button>
            <button className="btn btn-sm u-btn-primary" onClick={this.handleSave}>Update</button>
          </div>
          }
        </div>
    )
